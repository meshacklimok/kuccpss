"""Full audit of TVET Craft Certificate (Level 3) courses and offerings."""
...
ct = CourseType.objects.get(name="TVET Craft Certificate (Level 3)")
...
print(f"=== TVET Craft Certificate (Level 3) Audit ===")
...
# 2. Courses with wrong-type names
bad_name_re = re.compile(r"^(Diploma|Certificate in |Artisan|Bachelor|Master|Higher)", re.I)
